...
class Moondream2Model(BaseImageCaptionModel):
    def __init__(
        ...
        Args:
            ...
            versionnamne(str): One of the choices from get_version_names()
        ...
        if caption_length: 
            ...
            self.caption_length = "short" if "short" in versionname else "normal"
        self.stream = stream
        ...
        print("Moondream2Model: device type is ", device.type)
    ...
    def get_version_names() -> list[str]:
        return ["Moondream2-normal","Moondream2-short"]